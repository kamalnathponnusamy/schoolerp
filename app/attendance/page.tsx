  ...
  const saveAttendance = async () => {
    ...
    try {
      const attendanceData = students.map((student) => ({
        ...
        marked_by: 1, // TODO: Get actual teacher ID from session
        remarks: null
      }))
      ...
      const response = await fetch("/api/attendance/today", {
        ...
        body: JSON.stringify(attendanceData[0]), // Send first student for now
      })
              ...
              <Card>
                ...
                <CardContent>
                  {attendanceRecords.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-gray-500">No attendance records found for today</div>
                  )}
                </CardContent>
              </Card>
            </TabsContent>
